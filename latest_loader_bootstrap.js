(()=>{
 const files=[
  ...
  'content_adapter_v1.js','radar_106_115_priority_v1.js','question_quality_rules_v1.js','canonical_concepts_v1.js','personal_priority.js'
 ];
 files.forEach(src=>document.write('<script src="'+src+'?v=20260818p"></'+'script>'));
})();
...
`;document.head.appendChild(s)}
 ...
 function boot(){style();var n=0,t=setInterval(function(){n++;var ok=movePriority();softenLegacy();firstTip();validateEmpty();if(ok&&q('#hf115Guide')&&n>4)clearInterval(t);if(n>80)clearInterval(t)},180)}

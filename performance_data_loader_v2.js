(()=>{
  ...
  const GROUPS={
    questionCore:[
      'questions_recent.js',
      'questions_official_111_115.js',
      'questions_batch_114_jh_music_edu.js',
      'questions_batch_113_tainan.js',
      'source_index.js',
      'sources_115.js'
    ],
    questionArchive:[
      'questions_batch_114_newtaipei_tainan_ntnu_part7.js',
      'questions_batch_114_kaohsiung_taipei_part8.js',
      'questions_batch_115_latest_part1.js',
      'questions_batch_115_latest_part2.js',
      'questions_batch_115_newtaipei_part3.js',
      'questions_rare_batch1.js','questions_rare_batch2.js','questions_rare_batch3.js','questions_rare_batch4.js',
      'questions_rare_batch5.js','questions_rare_batch6.js','questions_rare_batch7.js','questions_rare_batch8.js',
      'questions_junior_111_batch1.js','questions_junior_112_115_batch2.js','questions_junior_112_115_batch3.js',
      'questions_junior_113_114_batch4.js','questions_junior_113_batch5.js','questions_junior_115_central_batch6.js',
      'questions_junior_115_central_taoyuan_batch7.js','questions_junior_115_taoyuan_kaohsiung_batch8.js',
      ...
      'questions_115_moe_nonchoice_batch12.js','questions_115_moe_nonchoice_batch13.js','questions_115_chsh_nonchoice_batch14.js',
      'questions_115_neihu_batch15.js','questions_112_tcfsh_batch16.js','questions_112_nchu_batch17.js',
      'questions_113_nchu_batch18.js','questions_113_moe_batch19.js','questions_113_newtaipei_batch20.js'
    ],
    termArchive:[
      ...
      'terms_114_ntnu_batch15.js','terms_112_moe_batch16.js','terms_112_tcfsh_batch17.js','terms_112_nchu_batch18.js','terms_113_nchu_batch19.js',
      'terms_113_moe_batch20.js','terms_113_newtaipei_batch21.js'
    ],
    essayArchive:[
    ...
    studyCore:[
      ...
      'precise_terms_106_110.js','precise_terms_106_109_batch2.js','precise_terms_106_110_part2.js',
      'precise_terms_107_moe_batch4.js','precise_terms_111_113_batch4.js','precise_terms_114_115_batch6.js',
      'precise_terms_edu_112_115_batch1.js','precise_terms_edu_113_115_batch8.js','precise_terms_edu_112_batch9.js',
      'precise_terms_edu_109_111_batch10.js','precise_terms_edu_106_108_batch11.js','precise_terms_radar.js'
    ],
    advanced:[
      'performance_loader_v1.js'
    ]
  };
  ...
  function intentFrom(target){
    ...
    if(id==='essayBtn'||id==='showHintBtn'||id==='nextEssayBtn'||group==='written'){
  ...
  // 首屏完成後，只先補最常用的近年選擇題。其餘資料等操作或更晚的閒置時間。
  const warmCore=()=>loadGroup('questionCore');
  if('requestIdleCallback'in window)requestIdleCallback(warmCore,{timeout:2200});
  else setTimeout(warmCore,900);

  // 逐層背景補齊，避免使用者一直停在首頁時永遠看不到完整資料。

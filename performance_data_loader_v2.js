(()=>{
  ...
  const GROUPS={
    questionCore:['questions_recent.js','questions_official_111_115.js','questions_batch_114_jh_music_edu.js','questions_batch_113_tainan.js','source_index.js','sources_115.js'],
    questionArchive:['questions_batch_114_newtaipei_tainan_ntnu_part7.js','questions_batch_114_kaohsiung_taipei_part8.js','questions_batch_115_latest_part1.js','questions_batch_115_latest_part2.js','questions_batch_115_newtaipei_part3.js','questions_rare_batch1.js','questions_rare_batch2.js','questions_rare_batch3.js','questions_rare_batch4.js','questions_rare_batch5.js','questions_rare_batch6.js','questions_rare_batch7.js','questions_rare_batch8.js','questions_junior_111_batch1.js','questions_junior_112_115_batch2.js','questions_junior_112_115_batch3.js','questions_junior_113_114_batch4.js','questions_junior_113_batch5.js','questions_junior_115_central_batch6.js','questions_junior_115_central_taoyuan_batch7.js','questions_junior_115_taoyuan_kaohsiung_batch8.js','questions_junior_115_kaohsiung_batch9.js','questions_junior_115_kaohsiung_batch10.js','questions_junior_115_kaohsiung_batch11.js','questions_115_moe_nonchoice_batch12.js','questions_115_moe_nonchoice_batch13.js','questions_115_chsh_nonchoice_batch14.js','questions_115_neihu_batch15.js','questions_112_tcfsh_batch16.js','questions_112_nchu_batch17.js','questions_113_nchu_batch18.js','questions_113_moe_batch19.js','questions_113_newtaipei_batch20.js','questions_108_110_backfill_batch21.js','questions_106_107_backfill_batch22.js','questions_107_highschool_depth_batch23.js','questions_107_music_education_batch24.js','questions_108_highschool_depth_batch25.js','questions_111_112_highschool_depth_batch26.js','questions_112_113_highschool_depth_batch27.js','questions_114_junior_senior_depth_batch28.js','questions_115_junior_senior_depth_batch29.js','questions_115_analysis_depth_batch30.js','content_adapter_v1.js'],
    termArchive:['terms_110_113.js','terms_112_115_extra.js','terms_111_115_extra2.js','terms_rare_batch3.js','terms_rare_batch4.js','terms_rare_batch5.js','terms_rare_batch6.js','terms_rare_batch7.js','terms_rare_batch8.js','terms_rare_batch9.js','terms_115_cksh_batch10.js','terms_115_moe_batch11.js','terms_115_chsh_batch12.js','terms_115_hchs_batch13.js','terms_115_zsgsh_batch14.js','terms_114_ntnu_batch15.js','terms_112_moe_batch16.js','terms_112_tcfsh_batch17.js','terms_112_nchu_batch18.js','terms_113_nchu_batch19.js','terms_113_moe_batch20.js','terms_113_newtaipei_batch21.js','terms_108_110_backfill.js','terms_109_highschool_backfill.js','terms_110_highschool_depth.js','terms_111_112_highschool_backfill.js','terms_113_highschool_backfill.js','terms_115_highschool_depth.js','terms_115_moe_changhua_batch31.js'],
    essayArchive:['essay_115_neihu_batch.js','essay_115_hchs_batch.js','essay_115_zsgsh_batch.js','essay_114_ntnu_batch.js','essay_112_moe_batch.js','essay_112_tcfsh_batch.js','essay_112_nchu_batch.js','essay_113_nchu_batch.js','essay_113_moe_batch.js','essay_113_newtaipei_batch.js','essay_107_lioujia_backfill.js','essay_108_changhua_girls_detailed.js','essay_110_highschool_detailed.js','essay_111_112_highschool_detailed.js','essay_113_highschool_detailed.js','essay_114_highschool_detailed.js','essay_115_junior_senior_detailed.js','essay_115_moe_changhua_batch31.js'],
    todayUi:['home-layering.js','mobile-home.js','score-hierarchy.js','daily_mission.js','daily_recommendation_115.js','daily_completion_115.js','weekly_learning_rhythm_115.js'],
  ...
  function loadScript(src){
    ...
    if(loaded.has(base)||[...document.scripts].some(s=>(s.getAttribute('src')||'').split('?')[0]===base)){loaded.add(base);return Promise.resolve(true)}
    return new Promise(resolve=>{const s=document.createElement('script');s.src=`${src}${src.includes('?')?'&':'?'}v=${VERSION}`;s.async=false;s.dataset.dataLazy='2';s.onload=()=>{loaded.add(base);resolve(true)};s.onerror=()=>resolve(false);document.body.appendChild(s)});
  }

  async function loadGroup(name,{yieldBetween=true}={}){
    if(state.has(name))return state.get(name);
    const job=(async()=>{for(const src of (GROUPS[name]||[])){if(yieldBetween)await idle(900);await loadScript(src)}refreshApp(name);window.dispatchEvent(new CustomEvent('musicExamDataGroupReady',{detail:{name}}));return true})();
  ...
  if('requestIdleCallback'in window)requestIdleCallback(warm,{timeout:1800});else setTimeout(warm,800);
  laterWhenHome(()=>loadGroup('todayUi'),1200);
  laterWhenHome(()=>loadGroup('polishUi'),2400);

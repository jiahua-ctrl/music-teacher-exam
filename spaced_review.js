(() => {
  ...
  function start(){ensureStyles();bootstrap();integrateTermLearning();setTimeout(()=>{render();observe()},30)}
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',start,{once:true});else start();
  window.MusicTeacherSRS={summary,update,bootstrap,stateOf,intervalFor,render};
})();
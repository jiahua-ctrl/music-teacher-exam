...
function setup(){const view=$('termView');if(!view||view.dataset.termLearningReady)return;view.dataset.termLearningReady='1';installStyles();const zh=$('termZh'),show=$('showTermBtn');if(zh)zh.style.display='none';
